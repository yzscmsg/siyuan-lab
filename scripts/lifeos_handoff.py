...
CONTRACT_EXPECTED = {
    ...
    "C4_illegal_media_type":              (False, True,
        "core.document media_type CHECK (migration 0006) rejects unknown types"),
    "C5_path_traversal":                  (False, True,
        "core.document storage_uri CHECK (migration 0006) rejects traversal/raw-IP URIs"),
